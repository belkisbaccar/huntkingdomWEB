...
<script type='text/javascript'>
/* <![CDATA[ */
var ajax_auth_object = {"ajaxurl":"https:\/\/www.urbanui.com\/wp-admin\/admin-ajax.php","redirecturl":"\/vanta\/template\/js\/iCheck.js","loadingmessage":"Please wait..."};
/* ]]> */
</script>
...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2020/01/cropped-UrbanUI-Favicon-270x270.png" />
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="f214752558" /><input type="hidden" name="_wp_http_referer" value="/vanta/template/js/iCheck.js" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="f0f8599bf9" /><input type="hidden" name="_wp_http_referer" value="/vanta/template/js/iCheck.js" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="4ce66f3dfc" /><input type="hidden" name="_wp_http_referer" value="/vanta/template/js/iCheck.js" />  
...
s1.async=true;
s1.src='https://embed.tawk.to/5dd259f6d96992700fc7ef93/default';
s1.charset='UTF-8';
s1.setAttribute('crossorigin','*');
s0.parentNode.insertBefore(s1,s0);
})();
</script>
<!--End of Tawk.to Script (0.3.3)--><script type='text/javascript' src='http://www.urbanui.com/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min.js?ver=2.70'></script>
<script type='text/javascript'>
/* <![CDATA[ */
